...
struct EnvOptions {
  ...
  bool posix_use_cloud_cache = false;
  bool aws_use_cloud_cache = false;
  std::shared_ptr<CloudCache> ccache = nullptr;
};
...
class LEVELDB_EXPORT Env {
 public:
  ...
  virtual CloudEnvOptions* GetCloudEnvOptionsPtr() { return nullptr; }
